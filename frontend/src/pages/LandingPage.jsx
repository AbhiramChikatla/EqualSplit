...
import { Users, PieChart, Wallet, ArrowRight, Check, DollarSign } from "lucide-react";
    ...
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <div className="relative z-10 grid lg:grid-cols-2 min-h-screen">
        ...
        <div className="flex items-center justify-center p-6 lg:p-12 bg-muted/30">
          <Card className="w-full max-w-md border-border/50 shadow-2xl animate-slide-up" data-testid="auth-card">
